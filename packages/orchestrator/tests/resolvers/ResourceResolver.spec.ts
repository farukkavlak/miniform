...
describe('ResourceResolver', () => {
    ...
    it('should throw if resource not found', () => {
        ...
        expect(() => resolver.resolve(['module', 'missing', 'resource', 'main', 'id'], context, mockState))
            .toThrow(/Resource "module.missing.resource.main" not found/);

        expect(() => resolver.resolve(['resource', 'missing', 'id'], context, mockState))
            .toThrow(/Resource "resource.missing" not found/);
    });
